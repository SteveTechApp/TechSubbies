...
export const Sparkles = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.9 5.8-5.8 1.9 5.8 1.9 1.9 5.8 1.9-5.8 5.8-1.9-5.8-1.9z"></path></svg>
);

export const Handshake = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 17a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2.5"/><path d="m14 14-2-2"/><path d="M13 17a2 2 0 0 0-2-2V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2.5"/><path d="m10 10-2-2"/></svg>
);
...
// FIX: Export X as XIcon for use in other components
export { X as XIcon };
...
export const MessageCircle = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"></path></svg>
);
...
export const Mail = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="2" y="4" width="20" height="16" rx="2"></rect><polyline points="22,6 12,13 2,6"></polyline></svg>
);
...
export const ShieldCheck = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg>
);
...
export const Clapperboard = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M20.2 6 3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4c1.1-.3 2.2.3 2.5 1.3Z"></path><path d="m6.2 5.3 3.1 3.9"></path><path d="m12.4 3.6 3.1 4"></path><path d="M3 11h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"></path></svg>
);

export const BrainCircuit = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.993.142"></path><path d="M18 13a3 3 0 1 0-4.42 2.495"></path><path d="M5 13a3 3 0 1 0-2.495 1.42"></path><path d="M12 21a3 3 0 1 0 .142-5.993"></path><path d="M14.532 10.92a3 3 0 1 0-2.45 2.153"></path><path d="M12 5V2"></path><path d="M12 22v-3"></path><path d="M22 12h-3"></path><path d="M5 12H2"></path><path d="m4.22 4.22.14.14"></path><path d="M3 21l3-3"></path><path d="M21 3l-3 3"></path><path d="m19.78 19.78-.14-.14"></path><path d="M14.58 15.42a5 5 0 1 0-5.16-5.16"></path><path d="M12 12a5 5 0 1 0-5-5"></path></svg>
);

export const Loader = ({ className, size = 24 }: IconProps) => (
...
export const BarChart2 = ({ className, size = 24 }: IconProps) => (
...
export const Lightbulb = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 18h6"></path><path d="M10 22h4"></path><path d="M12 2a7 7 0 0 1 5 12.24V18a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-3.76A7 7 0 0 1 12 2z"></path></svg>
);
...
export const Layers = ({ className, size = 24 }: IconProps) => (
...
export const KanbanSquare = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="3" x2="9" y2="21"></line><line x1="15" y1="3" x2="15" y2="21"></line></svg>
);

export const LifeBuoy = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="4"></circle><line x1="4.93" y1="4.93" x2="9.17" y2="9.17"></line><line x1="14.83" y1="14.83" x2="19.07" y2="19.07"></line><line x1="14.83" y1="9.17" x2="19.07" y2="4.93"></line><line x1="9.17" y1="14.83" x2="4.93" y2="19.07"></line></svg>
);
...
export const PlusCircle = ({ className, size = 24 }: IconProps) => (
...
export const PenSquare = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
);

export const Rocket = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.11.69-.7.34-2.28-.4-3.1.85-.68 2.34-1.05 3.1-.3.8.75 2.33 1.1 3.1.4.76-.7 2.29-1.07 3.09-.4.8.65 2.33 1.03 3.08.4.76-.7 2.33-1.04 3.09-.4.8-.65 2.32-1.03 3.08-.4.75-2.28.34-3.1-.4-.8-.76-2.32-1.1-3.1-.4-.75.7-2.28 1.08-3.08.4-.8-.66-2.32-1.04-3.08-.4-.76.7-2.32 1.04-3.08.4-.76-.7-2.32-1.04-3.08.4z"></path></svg>
);
...
export const StripeLogo = ({ className, size = 24 }: IconProps) => (
    <svg width="60" height="25" viewBox="0 0 60 25" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M52.95 10.2372C52.95 7.15243 51.13 4.90641 47.97 4.90641C44.81 4.90641 42.66 7.03112 42.66 10.0441C42.66 12.0163 43.71 13.5222 45.41 14.2882L45.92 14.5148C46.88 14.9281 47.1 15.2201 47.1 15.7058C47.1 16.3446 46.52 16.7173 45.69 16.7173C44.64 16.7173 44.02 16.304 43.98 15.6246L41.05 15.811C41.23 18.0163 42.97 19.4409 45.65 19.4409C48.97 19.4409 51.13 17.5898 51.13 14.9281C51.13 12.3877 49.63 11.086 47.45 10.1559L46.7 9.86386C45.96 9.57182 45.54 9.23912 45.54 8.7127C45.54 8.03333 46.12 7.58822 47.06 7.58822C48.27 7.58822 48.75 8.11463 48.83 8.794L51.72 8.64799C51.58 6.7562 49.98 5.49514 47.06 5.49514C44.73 5.49514 43.17 6.87788 43.17 8.92128C43.17 10.5158 44.06 11.5312 45.92 12.3366L46.47 12.5632C47.78 13.1413 48.27 13.627 48.27 14.3337C48.27 15.1391 47.53 15.811 46.43 15.811C45.26 15.811 44.64 15.2201 44.52 14.4812L41.67 14.668C41.91 17.2284 43.75 18.8143 46.43 18.8143C49.39 18.8143 51.72 17.1422 51.72 14.3337C51.72 11.834 49.94 10.6384 47.41 9.57182" fill="#6A73CF"></path>
        <path d="M12.91 19.2278H15.59L10.37 5.13293H7.6L2.42 19.2278H5.1L6.31 15.9323H11.7L12.91 19.2278ZM9.01 7.7915L10.86 13.1009H7.14L9.01 7.7915Z" fill="#6A73CF"></path>
        <path d="M25.043 13.3691C25.353 15.0818 26.853 16.2367 28.573 16.2367C30.663 16.2367 31.813 14.7342 31.813 13.1425C31.813 11.1232 30.033 10.1425 27.913 9.40875L26.623 8.96113C24.783 8.31046 24.163 7.53842 24.163 6.46788C24.163 5.23702 25.213 4.54415 26.543 4.54415C28.043 4.54415 28.923 5.31619 29.153 6.30528L31.813 5.91927C31.423 3.5583 29.333 2 26.543 2C23.943 2 21.853 3.51761 21.853 5.96001C21.853 8.32096 23.493 9.40875 25.863 10.2241L27.073 10.6311C28.843 11.2411 29.503 12.0131 29.503 13.2638C29.503 14.4947 28.453 15.226 27.123 15.226C25.403 15.226 24.523 14.286 24.233 13.1018L21.573 13.4904C21.963 16.0545 24.123 17.6473 27.123 17.6473C30.203 17.6473 32.443 15.9753 32.443 13.3284C32.443 10.3705 28.223 9.14175 27.913 9.40875" fill="#6A73CF"></path>
        <rect x="33.8" y="2.22656" width="2.64" height="17" fill="#6A73CF"></rect>
        <path d="M59.24 13.9113C59.24 16.9554 57.2 19.4409 53.76 19.4409C50.28 19.4409 48.28 16.9554 48.28 13.9113C48.28 10.8672 50.28 8.38171 53.76 8.38171C57.2 8.38171 59.24 10.8672 59.24 13.9113ZM51.23 13.9113C51.23 15.4292 52.2 16.7173 53.76 16.7173C55.32 16.7173 56.28 15.4292 56.28 13.9113C56.28 12.3934 55.32 11.1053 53.76 11.1053C52.2 11.1053 51.23 12.3934 51.23 13.9113Z" fill="#6A73CF"></path>
        <path d="M38.83 8.6084H41.47V19.2284H38.83V8.6084Z" fill="#6A73CF"></path>
        <path d="M42.26 8.6084H44.9V16.8284L49.12 8.6084H52.12L46.85 15.1184L52.25 24.0684H49.17L44.9 17.4184V24.0684H42.26V8.6084Z" fill="#6A73CF"></path>
    </svg>
);
...
export const Megaphone = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m3 11 18-5v12L3 14v-3z"></path><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"></path></svg>
);
...
export const PoundSterling = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M18 7c0-5.333-8-5.333-8 0"></path><path d="M10 7v14"></path><path d="M6 21h12"></path><path d="M6 13h10"></path></svg>
);

export const MousePointer = ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m3 3 7.07 16.97 2.51-7.39 7.39-2.51L3 3z"></path><path d="m13 13 6 6"></path></svg>
);

export const PlayCircle = ({ className, size = 24 }: IconProps) => (
