...
export const HowItWorksModal = ({ isOpen, onClose, onNavigate }: HowItWorksModalProps) => {
    ...
    return (
        ...
        >
            <div
                className="bg-white rounded-lg p-8 m-4 max-w-6xl w-full relative transform transition-all duration-300 scale-100"
            ...
            >
                ...
                <p className="text-center text-gray-500 mb-8">A streamlined process for every role in the industry.</p>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-12">
                    <div className="border-r-0 lg:border-r pr-0 lg:pr-8">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold text-center text-indigo-600 mb-6">For Resourcing Companies</h3>
                         <div className="space-y-8">
                            <Step icon={Users} title="1. Build Your Roster" description="Add your managed engineers to the platform and keep their availability and details in one central place." />
                            ...
                            <Step icon={Handshake} title="3. Streamline Bookings" description="Use our platform to manage communications and streamline the hiring process for your talent." />
                        </div>
                    </div>
                </div>
