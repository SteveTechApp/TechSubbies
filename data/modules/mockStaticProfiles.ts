...
export const MOCK_ENGINEER_STEVE: EngineerProfile = {
    ...
    compliance: { ...DEFAULT_COMPLIANCE, professionalIndemnity: { hasCoverage: true, amount: 2000000, isVerified: true, certificateUrl: 'cert.pdf' }, publicLiability: { hasCoverage: true, amount: 5000000, isVerified: true, certificateUrl: 'cert.pdf' } },
...
export const MOCK_ENGINEER_1: EngineerProfile = {
    ...
    compliance: { professionalIndemnity: { hasCoverage: true, amount: 2000000, certificateUrl: 'cert.pdf', isVerified: true }, publicLiability: { hasCoverage: true, amount: 5000000, certificateUrl: 'cert.pdf', isVerified: true }, siteSafe: true, cscsCard: true, ownPPE: true, hasOwnTransport: true, hasOwnTools: true, powerToolCompetency: 90, accessEquipmentTrained: 80, firstAidTrained: true, carriesSpares: true },
...
export const MOCK_ENGINEER_2: EngineerProfile = {
    ...
    compliance: { professionalIndemnity: { hasCoverage: true, amount: 1000000, isVerified: false }, publicLiability: { hasCoverage: true, amount: 2000000, isVerified: false }, siteSafe: false, cscsCard: true, ownPPE: true, hasOwnTransport: true, hasOwnTools: false, powerToolCompetency: 75, accessEquipmentTrained: 25, firstAidTrained: true, carriesSpares: false },
...
export const MOCK_ENGINEER_3: EngineerProfile = {
    ...
    compliance: { ...DEFAULT_COMPLIANCE, professionalIndemnity: { hasCoverage: true, amount: 2000000, isVerified: true }, publicLiability: { hasCoverage: true, amount: 10000000, isVerified: true }, siteSafe: true, cscsCard: true, ownPPE: true, hasOwnTransport: true },
