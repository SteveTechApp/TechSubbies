...
export const roleExpectations: RoleExpectation[] = [
  ...
  },
  {
    id: "av-rack-builder",
    roleFamily: "AV",
    roleTitle: "Rack Builder",
    responsibilityBand: "competent",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Competent specialist-build rate, adjusted for rack complexity and documentation requirements.",
    responsibilityStatement: "This role builds AV equipment racks from approved drawings, including mechanical assembly, signal and power wiring, termination, labelling, dressing, continuity checks and build documentation.",
    notIncludedUnlessSelected: ["System design", "Control programming", "DSP programming", "On-site commissioning", "Network switch configuration"],
    requiredSkills: [
      { skill: "Rack layout interpretation", minimumLevel: 4, importance: 5 },
      { skill: "Rack mechanical assembly", minimumLevel: 4, importance: 5 },
      { skill: "AV cable termination", minimumLevel: 4, importance: 5 },
      { skill: "Cable dressing and separation", minimumLevel: 4, importance: 5 },
      { skill: "Labelling standards", minimumLevel: 4, importance: 5 },
      { skill: "Continuity and basic signal testing", minimumLevel: 3, importance: 4 },
      { skill: "Build documentation", minimumLevel: 3, importance: 4 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true }),
    mismatchWarnings: ["Rack building competence does not imply commissioning or programming competence.", "Approved rack elevations and wiring schedules should be available before work begins."],
  },
  {
    id: "av-wireman-first-fix",
    roleFamily: "AV",
    roleTitle: "Wireman (1st Fix)",
    responsibilityBand: "competent",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: false,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Standard first-fix installation rate.",
    responsibilityStatement: "This role completes AV first-fix containment, cable pulling, routing, identification and preparation from approved drawings while protecting bend radius, segregation and installation quality.",
    notIncludedUnlessSelected: ["Second-fix termination", "Equipment installation", "System commissioning", "Electrical installation", "Design changes"],
    requiredSkills: [
      { skill: "AV cable pulling", minimumLevel: 4, importance: 5 },
      { skill: "Cable route interpretation", minimumLevel: 3, importance: 5 },
      { skill: "Containment awareness", minimumLevel: 3, importance: 4 },
      { skill: "Cable segregation", minimumLevel: 4, importance: 5 },
      { skill: "Cable labelling", minimumLevel: 4, importance: 5 },
      { skill: "Construction-site coordination", minimumLevel: 3, importance: 4 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, cscsOrEquivalentRequired: true, workingAtHeightCheckRequired: true }),
    mismatchWarnings: ["First-fix wiremen should not be assumed to terminate or commission systems.", "Confirm construction access, working-at-height and containment scope."],
  },
  {
    id: "led-install-engineer",
    roleFamily: "AV",
    roleTitle: "LED Install Engineer",
    responsibilityBand: "competent",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Specialist installation rate based on LED system scale and access requirements.",
    responsibilityStatement: "This role installs direct-view LED structures, cabinets, modules, power and data connections to approved designs, maintaining alignment, handling standards and installation records.",
    notIncludedUnlessSelected: ["Structural design", "Final LED calibration", "Processor programming", "Mains electrical work", "Content configuration"],
    requiredSkills: [
      { skill: "Direct-view LED installation", minimumLevel: 4, importance: 5 },
      { skill: "Cabinet alignment", minimumLevel: 4, importance: 5 },
      { skill: "LED module handling", minimumLevel: 4, importance: 5 },
      { skill: "LED power and data topology", minimumLevel: 3, importance: 4 },
      { skill: "Mechanical drawing interpretation", minimumLevel: 3, importance: 4 },
      { skill: "Working at height", minimumLevel: 3, importance: 4 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true, workingAtHeightCheckRequired: true, cscsOrEquivalentRequired: true }),
    mismatchWarnings: ["LED installation does not prove calibration or processor-configuration competence.", "Confirm structure, lifting, access and electrical responsibilities before attendance."],
  },
  {
    id: "led-commissioning-engineer",
    roleFamily: "AV",
    roleTitle: "LED Commissioning Engineer",
    responsibilityBand: "specialist",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Specialist LED commissioning and calibration rate.",
    responsibilityStatement: "This role commissions direct-view LED systems, including processor setup, cabinet mapping, redundancy, colour and brightness calibration, signal validation, fault isolation and handover records.",
    notIncludedUnlessSelected: ["Structural installation", "Mains electrical work", "Content production", "Permanent network administration"],
    requiredSkills: [
      { skill: "LED processor configuration", minimumLevel: 4, importance: 5 },
      { skill: "Cabinet mapping", minimumLevel: 4, importance: 5 },
      { skill: "LED calibration", minimumLevel: 4, importance: 5 },
      { skill: "Redundancy configuration", minimumLevel: 4, importance: 4 },
      { skill: "Video signal validation", minimumLevel: 4, importance: 5 },
      { skill: "LED fault isolation", minimumLevel: 4, importance: 5 },
      { skill: "Commissioning documentation", minimumLevel: 4, importance: 4 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true }),
    mismatchWarnings: ["Require evidence on the relevant LED processing platform.", "Installation experience alone is not sufficient for LED commissioning."],
  },
  {
    id: "live-event-sound-technician",
    roleFamily: "AV",
    roleTitle: "Live Event Sound Technician",
    responsibilityBand: "specialist",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Live-event audio rate, adjusted for show responsibility and hours.",
    responsibilityStatement: "This role prepares, operates and troubleshoots live-event audio systems, including consoles, microphones, RF, playback, stage patching, monitoring and show cues within the agreed production scope.",
    notIncludedUnlessSelected: ["Lighting operation", "Video operation", "Production management", "Rigging", "Permanent-install commissioning"],
    requiredSkills: [
      { skill: "Live sound console operation", minimumLevel: 4, importance: 5 },
      { skill: "Gain structure", minimumLevel: 4, importance: 5 },
      { skill: "Microphone and RF systems", minimumLevel: 4, importance: 5 },
      { skill: "Stage patching", minimumLevel: 4, importance: 4 },
      { skill: "Monitor mixing", minimumLevel: 3, importance: 4 },
      { skill: "Show cue discipline", minimumLevel: 4, importance: 5 },
      { skill: "Live audio fault-finding", minimumLevel: 4, importance: 5 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true }),
    mismatchWarnings: ["Confirm whether FOH, monitors, RF coordination or system-tech responsibility is required.", "Live sound competence should be supported by relevant event evidence."],
  },
  {
    id: "live-event-visual-technician",
    roleFamily: "AV",
    roleTitle: "Live Event Visual Technician",
    responsibilityBand: "specialist",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Live-event video rate, adjusted for system and show responsibility.",
    responsibilityStatement: "This role prepares, operates and troubleshoots live-event video systems, including switchers, playback, projection, LED feeds, confidence monitors, signal conversion and show cues.",
    notIncludedUnlessSelected: ["Audio operation", "Lighting operation", "Content production", "Rigging", "Permanent-install commissioning"],
    requiredSkills: [
      { skill: "Vision mixer operation", minimumLevel: 4, importance: 5 },
      { skill: "Playback systems", minimumLevel: 4, importance: 4 },
      { skill: "Projection and display setup", minimumLevel: 4, importance: 4 },
      { skill: "Video signal conversion", minimumLevel: 4, importance: 5 },
      { skill: "LED feed configuration", minimumLevel: 3, importance: 4 },
      { skill: "Show cue discipline", minimumLevel: 4, importance: 5 },
      { skill: "Live video fault-finding", minimumLevel: 4, importance: 5 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true }),
    mismatchWarnings: ["Confirm the required switcher, playback, projection and LED platforms.", "Live visual operation is distinct from permanent-install commissioning."],
  },
  {
    id: "live-event-general-engineer",
    roleFamily: "AV",
    roleTitle: "Live Event General Engineer",
    responsibilityBand: "competent",
    canWorkAlone: true,
    canLeadOthers: false,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "General live-event technical rate; specialist operation should be scoped separately.",
    responsibilityStatement: "This role supports broad live-event setup, operation and get-out tasks across common audio, video, staging and production systems, escalating specialist or safety-critical work appropriately.",
    notIncludedUnlessSelected: ["Specialist FOH mixing", "Specialist vision operation", "Lighting programming", "Rigging", "Production management"],
    requiredSkills: [
      { skill: "Event equipment setup", minimumLevel: 3, importance: 5 },
      { skill: "Audio and video signal basics", minimumLevel: 3, importance: 4 },
      { skill: "Cable management", minimumLevel: 4, importance: 5 },
      { skill: "Show-call discipline", minimumLevel: 3, importance: 5 },
      { skill: "Basic event fault-finding", minimumLevel: 3, importance: 4 },
      { skill: "Safe get-in and get-out", minimumLevel: 4, importance: 5 },
    ],
    siteReadiness: readiness({ ownToolsRequired: true, evidenceRequired: true, workingAtHeightCheckRequired: true }),
    mismatchWarnings: ["A general event engineer should not replace named audio, video, lighting or rigging specialists.", "Confirm working hours, access and production supervision."],
  },
  {
    id: "av-project-manager",
    roleFamily: "AV",
    roleTitle: "AV Project Manager",
    responsibilityBand: "lead",
    canWorkAlone: true,
    canLeadOthers: true,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "Project-management rate based on project value, complexity and delivery accountability.",
    responsibilityStatement: "This role owns AV project planning, programme, resources, commercial coordination, risk, stakeholder communication, change control, quality tracking and handover readiness.",
    notIncludedUnlessSelected: ["System design authority", "On-site lead installation", "Specialist programming", "Principal contractor duties", "Contractual legal advice"],
    requiredSkills: [
      { skill: "AV project planning", minimumLevel: 4, importance: 5 },
      { skill: "Programme management", minimumLevel: 4, importance: 5 },
      { skill: "Resource coordination", minimumLevel: 4, importance: 5 },
      { skill: "Risk and issue management", minimumLevel: 4, importance: 5 },
      { skill: "Commercial change control", minimumLevel: 4, importance: 4 },
      { skill: "Stakeholder communication", minimumLevel: 5, importance: 5 },
      { skill: "AV delivery knowledge", minimumLevel: 4, importance: 5 },
      { skill: "Handover governance", minimumLevel: 4, importance: 4 },
    ],
    siteReadiness: readiness({ evidenceRequired: true }),
    mismatchWarnings: ["Project-management competence should be evidenced by comparable AV delivery.", "Clarify commercial authority, design responsibility and site-management boundaries."],
  },
  {
    id: "it-project-manager",
    roleFamily: "IT",
    roleTitle: "IT Project Manager",
    responsibilityBand: "lead",
    canWorkAlone: true,
    canLeadOthers: true,
    requiresEvidence: true,
    requiresNamedSupervisor: false,
    typicalDayRateNote: "IT project-management rate based on programme complexity, governance and delivery accountability.",
    responsibilityStatement: "This role owns IT project planning, governance, resources, dependencies, risk, stakeholder communication, change control, deployment readiness and operational handover.",
    notIncludedUnlessSelected: ["Technical architecture authority", "Hands-on network configuration", "Cybersecurity sign-off", "Service management after handover", "Contractual legal advice"],
    requiredSkills: [
      { skill: "IT project planning", minimumLevel: 4, importance: 5 },
      { skill: "Programme and dependency management", minimumLevel: 4, importance: 5 },
      { skill: "Resource coordination", minimumLevel: 4, importance: 5 },
      { skill: "Risk and issue management", minimumLevel: 4, importance: 5 },
      { skill: "Change control", minimumLevel: 4, importance: 5 },
      { skill: "Stakeholder communication", minimumLevel: 5, importance: 5 },
      { skill: "IT delivery governance", minimumLevel: 4, importance: 5 },
      { skill: "Operational handover", minimumLevel: 4, importance: 4 },
    ],
    siteReadiness: readiness({ evidenceRequired: true }),
    mismatchWarnings: ["IT project-management experience should match the technology and delivery scale.", "Clarify architecture, security and operational ownership boundaries."],
  },
