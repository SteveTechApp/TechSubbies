...
export type AccountAuditEventType =
  ...
  | "membership.request_cancelled"
  | "membership.request_rejected"
  | "membership.activated"
  | "membership.checkout_created"
  | "membership.checkout_completed"
  | "membership.subscription_free"
  | "membership.subscription_incomplete"
  | "membership.subscription_incomplete_expired"
  | "membership.subscription_trialing"
  | "membership.subscription_active"
  | "membership.subscription_past_due"
  | "membership.subscription_unpaid"
