...
class ResourcingDashboard extends LitElement {
    activeView: string;
    ...
    render() {
        return html`
            ...
            <main class="flex-grow p-8 bg-gray-50">
                <h1 class="text-3xl font-bold mb-6">Resourcing Dashboard</h1>
...
customElements.define('resourcing-dashboard', ResourcingDashboard);