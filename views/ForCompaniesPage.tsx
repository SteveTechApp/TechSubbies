            ...
            <main className="flex-grow pt-14">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl">
                        <h1 className="text-2xl md:text-4xl font-extrabold mb-2">The Talent You Need. The Moment You Need It.</h1>
                        <p className="text-sm md:text-base mx-auto mb-4">Stop searching, start building. Post contracts for free and instantly access our network of skilled AV & IT freelance engineers with confirmed availability.</p>
                        <button onClick={() => onNavigate('login')} className="bg-blue-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-blue-700 transition-transform transform hover:scale-105">Find Talent for Free</button>
                    </div>
                </section>
                ...
                <section className="py-8 bg-white">
                    <div className="container mx-auto px-4 max-w-4xl text-center">
                        <div className="mb-6">
                            <h2 className="text-2xl font-bold text-gray-800 mb-2">Our Project-First Model: Why It's Free for You</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="flex flex-col items-center">
                                ...
                                <h3 className="font-bold text-base">You Post Contracts for Free</h3>
                             ...
                             <div className="flex flex-col items-center">
                                ...
                                <h3 className="font-bold text-base">Top Engineers Join</h3>
                             ...
                             <div className="flex flex-col items-center">
                                ...
                                <h3 className="font-bold text-base">Engineers Subscribe</h3>
                ...
                <section className="py-8 bg-gray-50">
                    <div className="container mx-auto px-4">
                        <h2 className="text-2xl font-bold text-center mb-6">Project Resourcing, Without the Hassle</h2>
                ...
                <section className="py-8 bg-gray-800 text-white">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-2xl font-bold mb-2">Ready to Build Your Project Team?</h2>
                        <p className="text-base mb-4">Find the perfect tech subcontractor for your next project today.</p>
