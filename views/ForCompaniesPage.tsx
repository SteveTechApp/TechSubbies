            ...
            <main className="flex-grow pt-24">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl">
                        ...
                        <p className="text-lg md:text-xl mx-auto mb-8">Stop searching, start building. Post contracts for free and instantly access our network of skilled AV & IT freelance engineers with confirmed availability.</p>
                ...
                <section className="py-16 bg-white">
                    <div className="container mx-auto px-4 max-w-4xl text-center">
                        <div className="mb-10">
                            <h2 className="text-4xl font-bold text-gray-800 mb-4">Our Project-First Model: Why It's Free for You</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col items-center">
                                ...
                                <h3 className="font-bold text-xl">You Post Contracts for Free</h3>
                                <p className="text-gray-500">Unlimited postings create maximum opportunity.</p>
                            </div>
                             <div className="flex flex-col items-center">
                                ...
                                <p className="text-gray-500">The best talent goes where the best projects are.</p>
                            </div>
                             <div className="flex flex-col items-center">
                ...
                <section className="py-12 bg-gray-800 text-white">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-4xl font-bold mb-4">Ready to Build Your Project Team?</h2>
                        <p className="text-xl mb-8">Find the perfect tech subcontractor for your next project today.</p>
                        <button onClick={() => onNavigate('login')} className="bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-transform transform hover:scale-105">Post Your First Contract</button>
                    </div>
                </section>
            </main>
